...
namespace _38_Goncharova_bob.NetWorkModel
{
    ...
    //                {
    //                    memory_elemnt = tmpStrWeights[i].Split(delim[0]);
    //                    for (int j = 0; j < numofprevneurons + 1; ++j)
    //                        weights[i, j] = double.Parse(memory_elemnt[j].Replace(',' , '.'), System.Globalization.CultureInfo.InvariantCulture);
    //                }
    //                break;
    //            case MemoryMode.SET:
    ...
    //                    { 
    //                        tmpArr[j] = random.NextDouble() - 0.5;
